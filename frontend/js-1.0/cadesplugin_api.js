...
window.check_browser = function check_browser() {
...
console.log("!!! check_browser: " + browserSpecs.name + ", " + browserSpecs.version);
// var create_object = CreateObject('CAdESCOM.About');
// console.log("!!! create_object: " + create_object);
...
function set_constantValues() {
    ...
    cadesplugin.AT_UECSYMMETRICKEY = 0x80000004;
    cadesplugin.AT_SYMMETRIC = 0x80000005;
...
function plugin_loaded_error(msg) {
    console.log("plugin_loaded_error!!! " + msg)
...
window.check_plugin_working = function check_plugin_working() {
...
//Export
cadesplugin.JSModuleVersion = "2.3.8";
...
console.log("cadesPlugin api loaded!!!")