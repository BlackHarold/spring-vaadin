package local.aep.spring_vaadin.views;
...
import local.aep.spring_vaadin.model.Element;
...
//        grid.addColumn(Element::getName).setHeader("Name");
//        grid.addColumn(Element::getDescription).setHeader("Description");
//        grid.addColumn(Element::getPrice).setHeader("Price");
